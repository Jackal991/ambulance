...
Config.Locations = {
    ...
    ["vehicle"] = {
        [1] = vector4(-1865.31, -300.70, 49.14, 40.29),
    },
    ["helicopter"] = {
        [1] = vector4(-1866.90, -352.33, 58.03, 143.03),
    },
    ["armory"] = {
    },
    ["roof"] = {
        [1] = vector3(-1855.31, -337.60, 58.07),
    },
    ["main"] = {
        [1] = vector3(-1844.99, -343.73, 49.45),
    },
    ["beds"] = {
        [1] = {coords = vector4(-1862.77, -334.36, 50.19, 324.61), taken = false, model = 1570477186},
        [2] = {coords = vector4(-1865.86, -332.01, 50.19, 326.86), taken = false, model = 1570477186},
        [3] = {coords = vector4(-1868.83, -330.07, 50.19, 320.03), taken = false, model = 1570477186},
        [4] = {coords = vector4(-1872.27, -327.21, 50.19, 321.43), taken = false, model = 1570477186},
        [5] = {coords = vector4(-1875.26, -324.79, 50.19, 318.71), taken = false, model = 1570477186},
        [6] = {coords = vector4(-1878.65, -322.13, 50.19, 326.47), taken = false, model = 1570477186},
        [7] = {coords = vector4(-1875.15, -317.81, 50.19, 150.18), taken = false, model = 1570477186},
        [8] = {coords = vector4(-1871.92, -320.61, 50.19, 140.98), taken = false, model = 1570477186},
        [9] = {coords = vector4(-1868.80, -323.21, 50.19, 138.89), taken = false, model = 1570477186},
    },
    ["bedspd"] = {
        [1] = {coords = vector4(473.2012, -1010.423, 26.721529, 285.89724), taken = false, model = 1631638868},

    },
    ["sandy"] = {
        [1] = {coords = vector4(1829.875, 3682.5827, 34.903217, 306.91754), taken = false, model = 1631638868},

    },
    ["bedsjail"] = {
        [1] = {coords = vector4(1761.987, 2594.6577, 46.658565, 276.02832), taken = false, model = 1631638868},
...
Config.AuthorizedVehicles = {
    ...
    [0] = {
        ...
        ["blazer2"] = "Quad Unit",
        ["lguard"] = "Beach Unit",
        ["emsnspeedo"] = "EMS Classic Speedo",
        ["emsv"] = "Coroner Old Speedo",
        ["BMW-x5_medic"] = "BMW PAramedic",
        ["DC_RoyalCustom___RS7_EMS"] = "EMS RS7",
        ["emsbmwm7"] = "EMS BMW M5",
        ["RoyalCustom_RSQ8_EMS"] = "EMS Q7",
        ["RoyalDodgeRAMems"] = "EMS Dodge Ram",
        ["RoyalG30Medic"] = "EMS BMW 5 Series",
        ["Ambulance_Dodge_RAM"] = "EMS Ram Ambulance",
        ["ambulance1"] = "Ambulance Unit OG",
        ["amrvan"] = "EMS Van",
        ["audirs6emsfire"] = "EMS Audi A6",
    },
    -- Grade 1
    [1] = {
        ["ambulance"] = "Ambulance Unit",
    ...
    [2] = {
        ...
        ["RoyalDodgeRAMems"] = "EMS Dodge Ram",
        ["RoyalG30Medic"] = "EMS BMW 5 Series",
        ["RoyalYamahaEMS_white"] = "EMS Yamaha",
        ["Ambulance_Dodge_RAM"] = "EMS Ram Ambulance",
        ["ambulance1"] = "Ambulance Unit OG",
        ["amrvan"] = "EMS Van",
        ["audirs6emsfire"] = "EMS Audi A6",
...
Config.BleedingStates = {
    [1] = {label = 'bleeding a little bit..', damage = 1000000, chance = 1},
    [2] = {label = 'bleeding..', damage = 1000000, chance = 1},
    [3] = {label = 'bleeding a lot..', damage = 1000000, chance = 1},
    [4] = {label = 'bleeding very much..', damage = 1000000, chance = 1},
}
